...
#define CKM_SHA224_RSA_PKCS                    (CKM_VENDOR_DEFINED + 0x110)
#define CKM_SHA224_RSA_PKCS_PSS                (CKM_VENDOR_DEFINED + 0x111)
#define CKM_SHA224                             (CKM_VENDOR_DEFINED + 0x112)
#define CKM_SHA224_HMAC                        (CKM_VENDOR_DEFINED + 0x113)
#define CKM_SHA224_HMAC_GENERAL                (CKM_VENDOR_DEFINED + 0x114)
#define CKM_SHA224_KEY_DERIVATION              (CKM_VENDOR_DEFINED + 0x115)
...
CK_RV CK_ENTRY CA_OpenApplicationID(CK_SLOT_ID slotID,
                                     CK_ULONG ulHigh,
                                     CK_ULONG ulLow);
CK_RV CK_ENTRY CA_OpenApplicationIDNew(CK_SLOT_ID slotID,
									   CK_ULONG ulHigh,
									   CK_ULONG ulLow,
									   CK_ULONG Container);
CK_RV CK_ENTRY CA_CloseApplicationIDNew(CK_SLOT_ID slotID,
									   CK_ULONG ulHigh,
									   CK_ULONG ulLow,
									   CK_ULONG Container);
...
/* other misc cloning (initially created for the Xenon project) */
CK_RV CK_ENTRY CA_XenonCloneObjectPart1( CK_SESSION_HANDLE hSourceSession,
			                 CK_BYTE_PTR pTWCFilenameString);

CK_RV CK_ENTRY CA_XenonCloneObjectPart2( CK_SESSION_HANDLE hTargetSession,
			                 CK_BYTE_PTR pTWCFilenameString,
			                 CK_BYTE_PTR pBlob1FilenameString);

CK_RV CK_ENTRY CA_XenonCloneObjectPart3( CK_SESSION_HANDLE hSourceSession,
                                         CK_ULONG ulObjectType,
                                         CK_OBJECT_HANDLE hObjectToCloneHandle,
			                 CK_BYTE_PTR pBlob1FilenameString, 
			                 CK_BYTE_PTR pBlob2FilenameString);

CK_RV CK_ENTRY CA_XenonCloneObjectPart4( CK_SESSION_HANDLE hTargetSession,
                                         CK_ULONG ulObjectType,
                                         CK_OBJECT_HANDLE hObjectToCloneHandle,
			                 CK_BYTE_PTR pBlob2FilenameString, 
                                         CK_OBJECT_HANDLE hClonedObjectHandle);
