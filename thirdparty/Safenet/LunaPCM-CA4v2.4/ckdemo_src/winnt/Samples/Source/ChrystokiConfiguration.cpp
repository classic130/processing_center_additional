...
char *ChrystokiConfiguration::LibraryFileName()
{
   ...
   pbSection = (char *) "Chrystoki";
	   ...
	   // Compute entry
	         ...
	         // Windows NT
	         pbEntry = "libNT64";
	         pbDefaultLibrary = "cryptoki_64.dll";
	#elif defined(OS_HPUX)	
			pbEntry = "LibHPUX64";		
			#ifdef PKCS11_V1
				pbDefaultLibrary = "/usr/lib/libcrystoki.sl";
			#else
				pbDefaultLibrary = "/usr/lib/libCryptoki2_64.sl";
			#endif
			...
			#else
				pbDefaultLibrary = (char *) "/usr/lib/libCryptoki2_64.so";
			#endif
	   ...
	   else
	   {
	      ...
	      else
	      {
			...
			pbEntry = "LibHPUX";		
				...
				pbDefaultLibrary = "/usr/lib/libcrystoki.sl";
			#else
				pbDefaultLibrary = "/usr/lib/llibCryptoki2.sl";
			#endif
			...
			#else
				pbDefaultLibrary = (char *) "/usr/lib/libCryptoki2.so";
			#endif
         ...
         else
         {
            ...
            else
            {
		      ...
		      pbEntry = "LibHPUX";		
			      ...
			      pbDefaultLibrary = "/usr/lib/libcrystoki.sl";
		      #else
			      pbDefaultLibrary = "/usr/lib/libCryptoki2.sl";
		      #endif
