...
{ return aCryptokiBridge.CA_XenonCloneObjectPart1 (hSourceSession,pTWCFilenameString); }

CK_RV CK_ENTRY CA_XenonCloneObjectPart2( CK_SESSION_HANDLE hTargetSession,
                                         CK_BYTE_PTR pTWCFilenameString,
                                         CK_BYTE_PTR pBlob1FilenameString)
{ return aCryptokiBridge.CA_XenonCloneObjectPart2 (hTargetSession,pTWCFilenameString,pBlob1FilenameString); }
...
{ return aCryptokiBridge.CA_XenonCloneObjectPart3 (hSourceSession,ulObjectType,hObjectToCloneHandle,pBlob1FilenameString,pBlob2FilenameString); }
...
{ return aCryptokiBridge.CA_XenonCloneObjectPart4 (hTargetSession,ulObjectType,hObjectToCloneHandle,pBlob2FilenameString,hClonedObjectHandle); }
