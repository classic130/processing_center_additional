...
private:
   ...
   CK_RV (ENTRY *dll_XenonCloneObjectPart1) ( CK_SESSION_HANDLE hSourceSession,
                                         CK_BYTE_PTR pTWCFilenameString);

   CK_RV (ENTRY *dll_XenonCloneObjectPart2) ( CK_SESSION_HANDLE hTargetSession,
                                         CK_BYTE_PTR pTWCFilenameString,
                                         CK_BYTE_PTR pBlob1FilenameString);

    CK_RV (ENTRY *dll_XenonCloneObjectPart3) ( CK_SESSION_HANDLE hSourceSession,
                                         CK_ULONG ulObjectType,
                                         CK_OBJECT_HANDLE hObjectToCloneHandle,
                                         CK_BYTE_PTR pBlob1FilenameString,
                                         CK_BYTE_PTR pBlob2FilenameString);

    CK_RV (ENTRY *dll_XenonCloneObjectPart4) ( CK_SESSION_HANDLE hTargetSession,
                                         CK_ULONG ulObjectType,
                                         CK_OBJECT_HANDLE hObjectToCloneHandle,
                                         CK_BYTE_PTR pBlob2FilenameString,
...
public:
   ...
   CK_RV CA_XenonCloneObjectPart1 ( CK_SESSION_HANDLE hSourceSession,
                                         CK_BYTE_PTR pTWCFilenameString);
   CK_RV CA_XenonCloneObjectPart2 ( CK_SESSION_HANDLE hTargetSession,
                                         CK_BYTE_PTR pTWCFilenameString,
                                         CK_BYTE_PTR pBlob1FilenameString);
    CK_RV CA_XenonCloneObjectPart3 ( CK_SESSION_HANDLE hSourceSession,
                                         CK_ULONG ulObjectType,
                                         CK_OBJECT_HANDLE hObjectToCloneHandle,
                                         CK_BYTE_PTR pBlob1FilenameString,
                                         CK_BYTE_PTR pBlob2FilenameString);
    CK_RV CA_XenonCloneObjectPart4 ( CK_SESSION_HANDLE hTargetSession,
                                         CK_ULONG ulObjectType,
                                         CK_OBJECT_HANDLE hObjectToCloneHandle,
                                         CK_BYTE_PTR pBlob2FilenameString,
                                         CK_OBJECT_HANDLE hClonedObjectHandle);
