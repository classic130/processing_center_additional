...
int main(int argc, char* argv[]) 
{
  ...
  while ( !feof( fpin ) )
  {
    ...
    if ( encode )
      Read16BitLine( szIn, uzInput, (unsigned *)&iInputSize );
    else
      Read8BitLine( szIn, (unsigned char *)szInput, (unsigned *)&iInputSize );
    ...
    if ( encode )
      ...
      res = Xcode_convertUTF8ToUTF16( (const unsigned char *)szInput, iInputSize, uzOutput, &iOutputSize );
