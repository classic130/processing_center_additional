...
#define GLONG_TO_LE(val)	((glong) GINT_TO_LE (val))
#define GULONG_TO_LE(val)	((gulong) GUINT_TO_LE (val))
#define GLONG_TO_BE(val)	((glong) GINT_TO_BE (val))
#define GULONG_TO_BE(val)	((gulong) GUINT_TO_BE (val))
#define GINT_TO_LE(val)		((gint) GINT_TO_LE (val))
#define GUINT_TO_LE(val)	((guint) GUINT_TO_LE (val))
#define GINT_TO_BE(val)		((gint) GINT_TO_BE (val))
#define GUINT_TO_BE(val)	((guint) GUINT_TO_BE (val))
