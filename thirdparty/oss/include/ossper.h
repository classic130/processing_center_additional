...
#if INT_MAX == 2147483647
extern void DLL_ENTRY _oss_penc_utf8unistr(struct ossGlobal *g, int *value, ULONG_LONG length);
#else
extern void DLL_ENTRY _oss_penc_utf8unistr(struct ossGlobal *g, long *value, ULONG_LONG length);
#endif
...
#if INT_MAX == 2147483647
extern void DLL_ENTRY _oss_pdec_utf8unistr(struct ossGlobal *g, void *length, int **ptr,
     int lengthsize);
#else
extern void DLL_ENTRY _oss_pdec_utf8unistr(struct ossGlobal *g, void *length, long **ptr,
     int lengthsize);
#endif
