/*
 * Copyright (C) 1993-1998 Open Systems Solutions, Inc.  All rights reserved.
 *
...
typedef struct berTbl {
    ...
    void *(DLL_ENTRY_FPTR *_System oss_reserve_work_spacep)(void *, size_t, size_t *);
...
typedef struct perTbl {
    ...
    void (DLL_ENTRY_FPTR *_System _oss_penc_utf8unistrp)  (void *, int *, ULONG_LONG);
    void (DLL_ENTRY_FPTR *_System _oss_pdec_utf8unistrp)  (void *, void *, int **, int);
#else
    ...
    void (DLL_ENTRY_FPTR *_System _oss_penc_utf8unistrp)  (void *, long *, ULONG_LONG);
    void (DLL_ENTRY_FPTR *_System _oss_pdec_utf8unistrp)  (void *, void *, long **, int);
#endif
    ...
    void (DLL_ENTRY_FPTR *_System _oss_lnchkp)             (unsigned char *, ULONG_LONG *, unsigned short, ULONG_LONG, ULONG_LONG);
