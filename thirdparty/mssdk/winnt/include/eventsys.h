...
#ifndef __ISubscriberControl_FWD_DEFINED__
#define __ISubscriberControl_FWD_DEFINED__
typedef interface ISubscriberControl ISubscriberControl;
#endif 	/* __ISubscriberControl_FWD_DEFINED__ */
...
#ifndef __IEventCustomizeSubscription_FWD_DEFINED__
#define __IEventCustomizeSubscription_FWD_DEFINED__
typedef interface IEventCustomizeSubscription IEventCustomizeSubscription;
#endif 	/* __IEventCustomizeSubscription_FWD_DEFINED__ */
...
#define EVENTSYSTEM_DEFAULT_DOMAIN_ID OLESTR("{26c409cc-ae86-11d1-b616-00805fc79216}")
...
EXTERN_C const IID IID_IFiringControl;
    ...
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE FireSubscription( 
            IEventSubscription __RPC_FAR *subscription) = 0;
    ...
    typedef struct IFiringControlVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *FireSubscription )( 
            IFiringControl __RPC_FAR * This,
            IEventSubscription __RPC_FAR *subscription);
...
#ifndef __ISubscriberControl_INTERFACE_DEFINED__
#define __ISubscriberControl_INTERFACE_DEFINED__

/* interface ISubscriberControl */
/* [unique][helpstring][oleautomation][uuid][object] */ 


EXTERN_C const IID IID_ISubscriberControl;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("E0498C92-4EFE-11d1-9971-00C04FBBB345")
    ISubscriberControl : public IUnknown
    {
    public:
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE PreEventCall( 
            /* [in] */ IEventSubscription __RPC_FAR *pISubscription) = 0;
        
    };
    
#else 	/* C style interface */

    typedef struct ISubscriberControlVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            ISubscriberControl __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *PreEventCall )( 
            ISubscriberControl __RPC_FAR * This,
            /* [in] */ IEventSubscription __RPC_FAR *pISubscription);
        
        END_INTERFACE
    } ISubscriberControlVtbl;

    interface ISubscriberControl
    {
        CONST_VTBL struct ISubscriberControlVtbl __RPC_FAR *lpVtbl;
    };
...
#define ISubscriberControl_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define ISubscriberControl_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define ISubscriberControl_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define ISubscriberControl_PreEventCall(This,pISubscription)	\
    (This)->lpVtbl -> PreEventCall(This,pISubscription)
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE ISubscriberControl_PreEventCall_Proxy( 
    ISubscriberControl __RPC_FAR * This,
    /* [in] */ IEventSubscription __RPC_FAR *pISubscription);


void __RPC_STUB ISubscriberControl_PreEventCall_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#endif 	/* __ISubscriberControl_INTERFACE_DEFINED__ */
...
#ifndef __IEventCustomizeSubscription_INTERFACE_DEFINED__
#define __IEventCustomizeSubscription_INTERFACE_DEFINED__

/* interface IEventCustomizeSubscription */
/* [unique][helpstring][oleautomation][dual][uuid][object] */ 


EXTERN_C const IID IID_IEventCustomizeSubscription;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("30341008-9903-11d1-B998-0000F805C593")
    IEventCustomizeSubscription : public IUnknown
    {
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Initialize( 
            /* [in] */ IUnknown __RPC_FAR *pIEventSystem,
            /* [in] */ BSTR bSubscriptionID) = 0;
        
    };
    
#else 	/* C style interface */

    typedef struct IEventCustomizeSubscriptionVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IEventCustomizeSubscription __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Initialize )( 
            IEventCustomizeSubscription __RPC_FAR * This,
            /* [in] */ IUnknown __RPC_FAR *pIEventSystem,
            /* [in] */ BSTR bSubscriptionID);
        
        END_INTERFACE
    } IEventCustomizeSubscriptionVtbl;

    interface IEventCustomizeSubscription
    {
        CONST_VTBL struct IEventCustomizeSubscriptionVtbl __RPC_FAR *lpVtbl;
    };
...
#define IEventCustomizeSubscription_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define IEventCustomizeSubscription_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define IEventCustomizeSubscription_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define IEventCustomizeSubscription_Initialize(This,pIEventSystem,bSubscriptionID)	\
    (This)->lpVtbl -> Initialize(This,pIEventSystem,bSubscriptionID)
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IEventCustomizeSubscription_Initialize_Proxy( 
    IEventCustomizeSubscription __RPC_FAR * This,
    /* [in] */ IUnknown __RPC_FAR *pIEventSystem,
    /* [in] */ BSTR bSubscriptionID);


void __RPC_STUB IEventCustomizeSubscription_Initialize_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#endif 	/* __IEventCustomizeSubscription_INTERFACE_DEFINED__ */
...
/* interface __MIDL_itf_eventsys_0243 */
/* [local] */ 

typedef /* [public] */ 
enum EventSystemErrors
...
extern RPC_IF_HANDLE __MIDL_itf_eventsys_0243_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_eventsys_0243_v0_0_s_ifspec;
