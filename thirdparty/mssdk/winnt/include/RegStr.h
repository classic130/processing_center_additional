...
#define REGSTR_PATH_DRIVERSIGN_DS   TEXT("Software\\Policies\\Microsoft\\Windows NT\\Driver Signing")
...
// Values under REGSTR_PATH_DRIVERSIGN_DS
#define REGSTR_VAL_BEHAVIOR_ON_FAILED_VERIFY  TEXT("BehaviorOnFailedVerify")

// Types of driver signing policies (apply to both DS and non-DS policy values
// defined above)
