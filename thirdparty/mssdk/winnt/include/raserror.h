...
/*
 * The PPP control protocol for this network protocol is not available on the remote machine.%0
 */
...
/*
 * ERROR_BUNDLE_NOT_FOUND%0
 */
#define ERROR_CANNOT_DO_CUSTOMDIAL           (RASBASE+155)
/*
 * Cannot perform automated dial because this entry has a custom dialer specified.%0
 */
#define ERROR_DIAL_ALREADY_IN_PROGRESS      (RASBASE+156)
/*
 * Another dial to the same entry is already in progress.
 */
#define ERROR_RASAUTO_CANNOT_INITIALIZE	    (RASBASE+157)
/*
 * RasAuto initialization failure.  Check the event log.%0
 */
#define ERROR_CONNECTION_ALREADY_SHARED      (RASBASE+158)
/*
 * Shared access is already enabled on the connection.%0
 */
#define ERROR_SHARING_CHANGE_FAILED          (RASBASE+159)
/*
 * An error occurred while the existing shared access was being changed.%0
 */
...
/*
 * An error occurred while shared access was being enabled for the connection.%0
 */
...
/*
 * Shared access cannot be enabled. There is more than one LAN connection other than the connection to be shared.%0
 */

#define RASBASEEND                           (RASBASE+163)
#endif // _RASERROR_H_
