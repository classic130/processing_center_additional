...
(*PMGM_RPF_CALLBACK)( 
    ...
    IN  OUT         PRTM_IP_ROUTE   prirRoute
);
...
typedef
DWORD (*PMGM_DELETION_ALERT_CALLBACK)( 
    IN              DWORD           dwSourceAddr,
    IN              DWORD           dwSourceMask,
    IN              DWORD           dwGroupAddr,
    IN              DWORD           dwGroupMask,
...
typedef
DWORD (*PMGM_NEW_MEMBER_CALLBACK)( 
    IN              DWORD           dwSourceAddr,
    IN              DWORD           dwSourceMask,
    IN              DWORD           dwGroupAddr,
    IN              DWORD           dwGroupMask
...
typedef struct _ROUTING_PROTOCOL_CONFIG {
    ...
    PMGM_DELETION_ALERT_CALLBACK    pfnDeletionAlertCallback;

    PMGM_NEW_MEMBER_CALLBACK        pfnNewMemberCallback;
    ...
    PMGM_IGMP_JOIN_CALLBACK         pfnIgmpJoinCallback;

    PMGM_IGMP_LEAVE_CALLBACK        pfnIgmpLeaveCallback;
