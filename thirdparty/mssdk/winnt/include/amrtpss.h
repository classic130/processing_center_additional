...
EXTERN_C const IID IID_ISilenceSuppressor;
    ...
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE GetPostplayTime( 
            /* [out] */ LPDWORD lpdwPostplayBufferTime) = 0;
        
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE SetPostplayTime( 
            /* [in] */ DWORD dwPostplayBufferTime) = 0;
        
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE GetKeepPlayTime( 
            /* [out] */ LPDWORD lpdwRunningAverageTime) = 0;
        
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE SetKeepPlayTime( 
            /* [in] */ DWORD dwRunningAverageTime) = 0;
        
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE GetThresholdIncrementor( 
            /* [out] */ LPDWORD lpdwThresholdIncrementor) = 0;
        
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE SetThresholdIncrementor( 
            /* [in] */ DWORD dwThresholdIncrementor) = 0;
        
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE GetBaseThreshold( 
            /* [out] */ LPDWORD lpdwBaseThreshold) = 0;
        
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE SetBaseThreshold( 
    ...
    typedef struct ISilenceSuppressorVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetPostplayTime )( 
            ISilenceSuppressor __RPC_FAR * This,
            /* [out] */ LPDWORD lpdwPostplayBufferTime);
        
        /* [id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetPostplayTime )( 
            ISilenceSuppressor __RPC_FAR * This,
            /* [in] */ DWORD dwPostplayBufferTime);
        
        /* [id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetKeepPlayTime )( 
            ISilenceSuppressor __RPC_FAR * This,
            /* [out] */ LPDWORD lpdwRunningAverageTime);
        
        /* [id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetKeepPlayTime )( 
            ISilenceSuppressor __RPC_FAR * This,
            /* [in] */ DWORD dwRunningAverageTime);
        
        /* [id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetThresholdIncrementor )( 
            ISilenceSuppressor __RPC_FAR * This,
            /* [out] */ LPDWORD lpdwThresholdIncrementor);
        
        /* [id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetThresholdIncrementor )( 
            ISilenceSuppressor __RPC_FAR * This,
            /* [in] */ DWORD dwThresholdIncrementor);
        
        /* [id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetBaseThreshold )( 
            ISilenceSuppressor __RPC_FAR * This,
            /* [out] */ LPDWORD lpdwBaseThreshold);
        
        /* [id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetBaseThreshold )( 
            ISilenceSuppressor __RPC_FAR * This,
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISilenceSuppressor_GetPostplayTime_Proxy( 
    ISilenceSuppressor __RPC_FAR * This,
    /* [out] */ LPDWORD lpdwPostplayBufferTime);
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISilenceSuppressor_SetPostplayTime_Proxy( 
    ISilenceSuppressor __RPC_FAR * This,
    /* [in] */ DWORD dwPostplayBufferTime);
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISilenceSuppressor_GetKeepPlayTime_Proxy( 
    ISilenceSuppressor __RPC_FAR * This,
    /* [out] */ LPDWORD lpdwRunningAverageTime);
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISilenceSuppressor_SetKeepPlayTime_Proxy( 
    ISilenceSuppressor __RPC_FAR * This,
    /* [in] */ DWORD dwRunningAverageTime);
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISilenceSuppressor_GetThresholdIncrementor_Proxy( 
    ISilenceSuppressor __RPC_FAR * This,
    /* [out] */ LPDWORD lpdwThresholdIncrementor);
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISilenceSuppressor_SetThresholdIncrementor_Proxy( 
    ISilenceSuppressor __RPC_FAR * This,
    /* [in] */ DWORD dwThresholdIncrementor);
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISilenceSuppressor_GetBaseThreshold_Proxy( 
    ISilenceSuppressor __RPC_FAR * This,
    /* [out] */ LPDWORD lpdwBaseThreshold);
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISilenceSuppressor_SetBaseThreshold_Proxy( 
    ISilenceSuppressor __RPC_FAR * This,
    /* [in] */ DWORD dwBaseThreshold);
