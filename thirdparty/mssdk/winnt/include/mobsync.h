...
EXTERN_C const IID IID_ISyncMgrSynchronizeCallback;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE ShowErrorCompleted( 
            /* [in] */ HRESULT hr,
            /* [in] */ ULONG cbNumItems,
            /* [in] */ SYNCMGRITEMID __RPC_FAR *pItemIDs) = 0;
...
#define ISyncMgrRegister_RegisterSyncMgrHandler(This,rclsidHandler,pwszDescription,dwReserved)	\
    (This)->lpVtbl -> RegisterSyncMgrHandler(This,rclsidHandler,pwszDescription,dwReserved)
...
typedef struct tagRFCDLGPARAMW {                                                 
    ...
    HBITMAP hbKeepBoth;             // Bitmap                                    
    HBITMAP hbKeepLocal;            //                                           
    HBITMAP hbKeepNetwork;          //                                           
