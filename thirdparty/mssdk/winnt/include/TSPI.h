...
DECLARE_OPAQUE32(HDRVMSPCALL);
DECLARE_OPAQUE32(HDRVPARTICIPANT);
...
typedef HTAPIMSPCALL FAR * LPHTAPIMSPCALL;
...
typedef struct LINEMSPCALLINFO_tag
{
    DWORD           dwTotalSize;

    HTAPIMSPCALL    htMSPCall;

    HDRVMSPCALL     hdMSPCall;
    ...
    DWORD           dwMSPBufferSize;

    DWORD           dwMSPBufferOffset;

} LINEMSPCALLINFO, * LPLINEMSPCALLINFO;

typedef struct LINEPARTICIPANTLIST_tag
{
    DWORD           dwTotalSize;
    ...
    DWORD           dwTotalCurrentParticipants;

    DWORD           dwParticipantsNumEntries;

    DWORD           dwParticipantsSize;

    DWORD           dwParticipantsOffset;

} LINEPARTICIPANTLIST, * LPLINEPARTICIPANTLIST;

#define     MAX_PARTICIPANT_INFO_SIZE           256


typedef struct PARTICIPANTINFO_tag
{
    DWORD           dwInformationType;

    WCHAR           wszInfo[MAX_PARTICIPANT_INFO_SIZE];

} PARTICIPANTINFO, * LPPARTICIPANTINFO;

typedef struct LINEPARTICIPANTINFOLIST_tag
{
    DWORD           dwTotalSize;
    ...
    DWORD           dwParticipantInfoListSize;

    DWORD           dwParticipantInfoListOffset;

} LINEPARTICIPANTINFOLIST, * LPLINEPARTICIPANTINFOLIST;
...
typedef struct LINECALLQOSINFO_tag
{
    ...
    union
    {
        ...
        struct
        {
            DWORD               dwNumParticipantEntries;

            HDRVPARTICIPANT     Participants[1];

        } SetQOSParticipantList;
    };
...
#define LINE_SENDMSPDATA                        ((long) TSPI_MESSAGE_BASE + 5)
                                                                // TSPI v3.0
#define LINE_PARTICIPANTCHANGE                  ((long) TSPI_MESSAGE_BASE + 6)
                                                                // TSPI v3.0
#define LINE_QOSINFO                            ((long) TSPI_MESSAGE_BASE + 7)
                                                                // TSPI v3.0
#endif
...
#if (TAPI_CURRENT_VERSION >= 0x00030000)
#define MSPCALLINFOREASON_MSPSETUPCALL          1L              // TSPI v3.0
#define MSPCALLINFOREASON_INFO                  2L              // TSPI v3.0

#define LINEPARTICIPANTINFOTYPE_CNAME           0x00000001      // TSPI v3.0
#define LINEPARTICIPANTINFOTYPE_NAME            0x00000002      // TSPI v3.0
#define LINEPARTICIPANTINFOTYPE_EMAIL           0x00000004      // TSPI v3.0
#define LINEPARTICIPANTINFOTYPE_PHONE           0x00000008      // TSPI v3.0
#define LINEPARTICIPANTINFOTYPE_LOCATION        0x00000010      // TSPI v3.0
#define LINEPARTICIPANTINFOTYPE_TOOL            0x00000020      // TSPI v3.0
#define LINEPARTICIPANTINFOTYPE_NOTE            0x00000040      // TSPI v3.0

#define LINEPARTICIPANTCHANGE_JOIN              0x00000001      // TSPI v3.0
#define LINEPARTICIPANTCHANGE_LEAVE             0x00000002      // TSPI v3.0
#define LINEPARTICIPANTCHANGE_INFO              0x00000003      // TSPI v3.0
...
#define LINEQOSREQUESTTYPE_PARTICIPANTLIST      0x00000002      // TSPI v3.0
...
LONG
TSPIAPI
TSPI_lineGetParticipantInfo(
    HDRVCALL                    hdCall,
    HDRVPARTICIPANT             hdParticipant,
    DWORD                       dwRequestedParticipantInfoTypes,
    LPLINEPARTICIPANTINFOLIST   lpLineParticipantInfoList
    );

LONG
TSPIAPI
TSPI_lineGetParticipants(
    HDRVCALL                hdCall,
    BOOL                    bNotify,
    LPLINEPARTICIPANTLIST   lpLineParticipantList
    );
#endif
...
#define TSPI_LINEMAKECALLMSP                (TSPI_PROC_BASE + 106) // TSPI v3.0
#define TSPI_LINEANSWERMSP                  (TSPI_PROC_BASE + 107) // TSPI v3.0
#define TSPI_LINERECEIVEMSPDATA             (TSPI_PROC_BASE + 108) // TSPI v3.0
#define TSPI_LINEMSPIDENTIFY                (TSPI_PROC_BASE + 109) // TSPI v3.0
