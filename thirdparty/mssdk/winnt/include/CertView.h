...
EXTERN_C const IID IID_IEnumCERTVIEWCOLUMN;
    ...
    IEnumCERTVIEWCOLUMN : public IUnknown
    {
    public:
...
EXTERN_C const IID IID_IEnumCERTVIEWATTRIBUTE;
    ...
    IEnumCERTVIEWATTRIBUTE : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE Next( 
            /* [retval][out] */ LONG __RPC_FAR *pIndex) = 0;
...
EXTERN_C const IID IID_IEnumCERTVIEWEXTENSION;
    ...
    IEnumCERTVIEWEXTENSION : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE Next( 
            /* [retval][out] */ LONG __RPC_FAR *pIndex) = 0;
...
EXTERN_C const IID IID_IEnumCERTVIEWROW;
    ...
    IEnumCERTVIEWROW : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE Next( 
            /* [retval][out] */ LONG __RPC_FAR *pIndex) = 0;
...
#ifndef __CERTVIEWLib_LIBRARY_DEFINED__
#define __CERTVIEWLib_LIBRARY_DEFINED__

/* library CERTVIEWLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_CERTVIEWLib;
...
CCertView;
#endif
#endif /* __CERTVIEWLib_LIBRARY_DEFINED__ */
