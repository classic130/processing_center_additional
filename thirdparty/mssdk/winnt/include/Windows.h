...
#pragma message ("Windows NT 5.0 features. When these headers were released, Windows")
#pragma message ("NT 5.0 Beta 2 was the current versions.")
#pragma message ("")
...
#pragma message ("set WINVER to less than 0x0500 or visit http://www.microsoft.com/msdn/sdk")
#pragma message ("to see if retail Windows NT 5.0 headers are available.")
#pragma message ("")
