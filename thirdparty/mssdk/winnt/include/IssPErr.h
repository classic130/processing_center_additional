...
//
// MessageId: SEC_E_CERTIFICATE_UNTRUSTED_ISSUER
//
// MessageText:
//
//  The certificate received from the remote computer was issued by an untrusted authority.
//
#define SEC_E_CERTIFICATE_UNTRUSTED_ISSUER ((HRESULT)0x80090325L)

//
// MessageId: SEC_E_CERTIFICATE_REVOKED
//
// MessageText:
//
//  The certificate received from the remote computer has been revoked.
//
#define SEC_E_CERTIFICATE_REVOKED        ((HRESULT)0x80090326L)

//
// MessageId: SEC_E_CERTIFICATE_UNKNOWN
//
// MessageText:
//
//  The certificate received from the remote computer is unacceptable.
//
#define SEC_E_CERTIFICATE_UNKNOWN        ((HRESULT)0x80090327L)

//
// MessageId: SEC_E_CERTIFICATE_EXPIRED
//
// MessageText:
//
//  The certificate received from the remote computer has expired or is not currently valid.
//
#define SEC_E_CERTIFICATE_EXPIRED        ((HRESULT)0x80090328L)
