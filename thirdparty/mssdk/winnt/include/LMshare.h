...
typedef struct _SESSION_INFO_2 {
    LPWSTR    sesi2_cname;              // client name (no backslashes)
...
typedef struct _SESSION_INFO_502 {
    LPWSTR    sesi502_cname;             // client name (no backslashes)
