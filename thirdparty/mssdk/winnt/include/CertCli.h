...
/* interface __MIDL_itf_certcli_0108 */
/* [local] */ 
...
#define	GETCERT_FILEVERSION	( 0x66696c65 )

#define	GETCERT_PRODUCTVERSION	( 0x70726f64 )

#define	GETCERT_EXITVERSION	( 0x65786974 )

#define	GETCERT_POLICYVERSION	( 0x706f6c69 )

#define	GETCERT_CANAME	( 0x6e616d65 )

#define	GETCERT_VERSIONMASK	( 0x7f7f7f7f )

#define	GETCERT_CHAIN	( 0x80000000 )



extern RPC_IF_HANDLE __MIDL_itf_certcli_0108_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_certcli_0108_v0_0_s_ifspec;
