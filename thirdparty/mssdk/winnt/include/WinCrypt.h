...
#ifdef USE_TIPEM_FOR_WINCRYPT
} X_CERT_INFO, *PCERT_INFO;
#else
...
#define CERT_FIRST_RESERVED_PROP_ID         22
...
//  CERT_ARCHIVED_PROP_ID. By default, this flag is implicitly set for the
//  "My\.Default" CurrentUser and LocalMachine physical stores.
//
...
//      CERT_SYSTEM_STORE_USERS, CERT_SYSTEM_STORE_CURRENT_USER_GROUP_POLICY and
...
//      If the certificate already exists, then, the existing certificate
//      context is deleted before creating and adding the new context.
//      The added context inherits properties from the existing certificate
//      context.
...
//      If the certificate already exists, then, the existing certificate
//      context is deleted before creating and adding a new context.
//      Properties of the existing certificate context are merged with
...
//  See flag definition for more details.
//
...
//
//  For CERT_SYSTEM_STORE_LOCAL_MACHINE or
//  CERT_SYSTEM_STORE_LOCAL_MACHINE_GROUP_POLICY, pvSystemStoreLocationPara can
...
//
//  pvExtraPolicyPara may optionally be set to point to the
//  SSL_EXTRA_CERT_CHAIN_POLICY_PARA data structure defined in softpub.h.
//--------------------------------------------------------------------------
