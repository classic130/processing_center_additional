...
#ifdef UNICODE
typedef SP_DRVINFO_DATA_V1_W SP_DRVINFO_DATA;
typedef PSP_DRVINFO_DATA_V1_W PSP_DRVINFO_DATA;
#else
typedef SP_DRVINFO_DATA_V1_A SP_DRVINFO_DATA;
typedef PSP_DRVINFO_DATA_V1_A PSP_DRVINFO_DATA;
#endif

#else // use current version of driver info data structure
...
//
#define DRIVER_HARDWAREID_RANK  0x00000FFF      // Any rank less than this value is a HardwareID match
...
#define SPDRP_MAXIMUM_PROPERTY            (0x00000017)  // Upper bound on ordinals
