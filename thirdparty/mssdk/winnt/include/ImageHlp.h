...
typedef struct _IMAGE_DEBUG_INFORMATION64 {
    LIST_ENTRY List;
    DWORD Size;
    PVOID MappedBase;
    USHORT Machine;
    ...
    PVOID FunctionTableEntries;
    DWORD64 LowestFunctionStartingAddress;
    DWORD64 HighestFunctionEndingAddress;
    ...
    DWORD64 OriginalFunctionTableBaseAddress;

    DWORD64 Reserved[ 2 ];

} IMAGE_DEBUG_INFORMATION64, *PIMAGE_DEBUG_INFORMATION64;

#if !defined(_IMAGEHLP_SOURCE_) && defined(_IMAGEHLP64)
#define IMAGE_DEBUG_INFORMATION IMAGE_DEBUG_INFORMATION64
#define PIMAGE_DEBUG_INFORMATION PIMAGE_DEBUG_INFORMATION64
#else
...
PIMAGE_DEBUG_INFORMATION64
IMAGEAPI
MapDebugInformation64(
    HANDLE FileHandle,
    PSTR FileName,
    PSTR SymbolPath,
    DWORD64 ImageBase
...
#if !defined(_IMAGEHLP_SOURCE_) && defined(_IMAGEHLP64)
#define MapDebugInformation MapDebugInformation64
#else
...
BOOL
IMAGEAPI
UnmapDebugInformation64(
    PIMAGE_DEBUG_INFORMATION64 DebugInfo
    );

#if !defined(_IMAGEHLP_SOURCE_) && defined(_IMAGEHLP64)
#define UnmapDebugInformation UnmapDebugInformation64
#else
BOOL
IMAGEAPI
