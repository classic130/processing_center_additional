...
#define INTERNET_FLAG_USE_CACHED_COPY   0x00000020  // use cached copy if exist
...
#define ICU_ENCODE_PERCENT      0x00001000      // Encode any percent (ASCII25)
        // signs encountered, default is to not encode percent. IE5 Bug#21680
...
#define INTERNET_LAST_OPTION                    INTERNET_OPTION_CACHE_TIMESTAMPS
