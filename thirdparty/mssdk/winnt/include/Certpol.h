...
#ifndef __CCertManagePolicyModule_FWD_DEFINED__
#define __CCertManagePolicyModule_FWD_DEFINED__

#ifdef __cplusplus
typedef class CCertManagePolicyModule CCertManagePolicyModule;
#else
typedef struct CCertManagePolicyModule CCertManagePolicyModule;
#endif /* __cplusplus */

#endif 	/* __CCertManagePolicyModule_FWD_DEFINED__ */
...
EXTERN_C const CLSID CLSID_CCertManagePolicyModule;

#ifdef __cplusplus

class DECLSPEC_UUID("6853e76a-bd3e-11d1-9a4d-00c04fc297eb")
