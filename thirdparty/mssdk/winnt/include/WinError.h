...
//  Error Status: 0x%2. Click OK to shut down the system, then select Safe Mode during reboot. For more information, check the event log.
//
#define ERROR_SAM_INIT_FAILURE           4215L
...
// MessageText:
//
//  Cannot add media because the library is full.
//
...
// MessageText:
//
//  This resource cannot be created because the cluster has reached the
//  limit on the number of resources it can monitor.
//
...
// MessageText:
//
//  The specified node does not support a resource of this type.  This may be due to
...
// MessageText:
//
//  The specified resource name is supported by this resource DLL. This may be due
...
// MessageText:
//
//  The operation must be performed at the master DSA.  The DNS root attribute is
//  missing on the cross-reference object.
//
...
// MessageText:
//
//  An attribute's range constaint has been violated.
//
...
// MessageText:
//
//  The Windows NT directory service is too busy to complete the replication operation at this time.
//
...
//  ESE error code base
//  
//  See esent.h for a definition of the Extensible Storage Engine runtime errors.
//  Negative ESE error values are masked to three hex digits and offset by CERTDB_E_JET_ERROR.
//
