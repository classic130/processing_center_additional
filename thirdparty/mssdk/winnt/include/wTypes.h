...
#if defined(_WIN32) && (defined(_WINGDI_) && !defined(NOGDI))
...
#endif  // defined(_WIN32) && (defined(_WINGDI_) && !defined(NOGDI))
...
enum tagTYSPEC
	...
	TYSPEC_SCRIPTNAME	= TYSPEC_PACKAGENAME + 1
    }	TYSPEC;
...
#define	ACTFLG_OnDemandInstall	( 64 )

#define	ACTFLG_Orphan	( 128 )

#define	ACTFLG_Uninstall	( 256 )

#define	ACTFLG_Pilot	( 512 )

#define	ACTFLG_Assigned	( 1024 )

#define	ACTFLG_OrphanOnPolicyRemoval	( 2048 )

#define	ACTFLG_UninstallOnPolicyRemoval	( 4096 )

#define	ACTFLG_Migrate	( 8192 )

#define	ACTFLG_ForceUpgrade	( 16384 )

#define	UPGFLG_Uninstall	( 1 )

#define	UPGFLG_NoUninstall	( 2 )

#define	UPGFLG_UpgradedBy	( 4 )
...
typedef struct  tagCLASSDETAIL
    ...
    /* [size_is] */ LPOLESTR __RPC_FAR *prgProgId;
    }	CLASSDETAIL;

typedef struct  tagACTVATIONINFO
    {
    UINT cClasses;
    /* [size_is] */ CLASSDETAIL __RPC_FAR *pClasses;
    UINT cShellFileExt;
    /* [size_is] */ LPOLESTR __RPC_FAR *prgShellFileExt;
    /* [size_is] */ UINT __RPC_FAR *prgPriority;
    UINT cInterfaces;
    /* [size_is] */ IID __RPC_FAR *prgInterfaceId;
    UINT cTypeLib;
    /* [size_is] */ GUID __RPC_FAR *prgTlbId;
    }	ACTIVATIONINFO;
...
typedef struct  tagPLATFORMINFO
    {
    UINT cPlatforms;
    /* [size_is] */ CSPLATFORM __RPC_FAR *prgPlatform;
    UINT cLocales;
    /* [size_is] */ LCID __RPC_FAR *prgLocale;
    }	PLATFORMINFO;
...
typedef struct  tagPACKAGEDETAIL
    ...
    UINT cSources;
    /* [size_is] */ LPOLESTR __RPC_FAR *pszSourceList;
    UINT cCategories;
    /* [size_is] */ GUID __RPC_FAR *rpCategory;
    ACTIVATIONINFO __RPC_FAR *pActInfo;
    PLATFORMINFO __RPC_FAR *pPlatformInfo;
    INSTALLINFO __RPC_FAR *pInstallInfo;
    }	PACKAGEDETAIL;
