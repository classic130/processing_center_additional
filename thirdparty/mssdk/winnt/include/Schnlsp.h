...
#define SCH_CRED_DO_REVOCATION_CHECKING     0x00000001  // server cert validation
#define SCH_CRED_NO_SYSTEM_MAPPER           0x00000002  // client cert mapping
#define SCH_CRED_NO_SERVERNAME_CHECK        0x00000004  // server cert validation
#define SCH_CRED_MANUAL_CRED_VALIDATION     0x00000008  // server cert validation
#define SCH_CRED_NO_DEFAULT_CREDS           0x00000010  // client certificate selection
#define SCH_CRED_AUTO_CRED_VALIDATION       0x00000020  // server cert validation
#define SCH_CRED_USE_DEFAULT_CREDS          0x00000040  // client certificate selection
