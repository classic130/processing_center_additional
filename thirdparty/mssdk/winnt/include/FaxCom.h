...
#define IFaxPorts_get__NewEnum(This,pVal)	\
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IFaxPorts_get__NewEnum_Proxy( 
    IFaxPorts __RPC_FAR * This,
    /* [retval][out] */ LPUNKNOWN __RPC_FAR *pVal);


void __RPC_STUB IFaxPorts_get__NewEnum_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#define IFaxRoutingMethodS_get__NewEnum(This,pVal)	\
    (This)->lpVtbl -> get__NewEnum(This,pVal)
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IFaxRoutingMethodS_get__NewEnum_Proxy( 
    IFaxRoutingMethodS __RPC_FAR * This,
    /* [retval][out] */ LPUNKNOWN __RPC_FAR *pVal);


void __RPC_STUB IFaxRoutingMethodS_get__NewEnum_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
