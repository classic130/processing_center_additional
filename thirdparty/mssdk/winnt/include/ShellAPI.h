...
#if (_WIN32_IE >= 0x0500)
#define SEE_MASK_USERLOGON        0x00800000
...
#define NIN_GETVERSION      (WM_USER + 0)
#define NIN_SELECT          (WM_USER + 0x2)
#define NINF_KEY            0x1
...
SHSTDAPI_(DWORD_PTR) SHGetFileInfoA(LPCSTR pszPath, DWORD dwFileAttributes, SHFILEINFOA FAR *psfi, UINT cbFileInfo, UINT uFlags);
SHSTDAPI_(DWORD_PTR) SHGetFileInfoW(LPCWSTR pszPath, DWORD dwFileAttributes, SHFILEINFOW FAR *psfi, UINT cbFileInfo, UINT uFlags);
#ifdef UNICODE
