...
#define KSDSOUND_BUFFER_CTRL_IIR_3D         0x40000000
...
// DirectSound3D IIR message struct

typedef struct {
    ULONG                   Size;           // This is the total size
                                            // including the coeff data
    ULONG                   Enabled;
    ULONG                   Mute;
    BOOL                    SwapChannels;
    BOOL                    ZeroAzimuth;
    ULONG                   Reserved;
} KSDS3D_IIR_PARAMS_MSG, *PKSDS3D_IIR_PARAMS_MSG;
...
} KSDS3D_IIR_FILTER_METHOD;

typedef struct {
    KSDS3D_IIR_FILTER_METHOD    FilterMethod;
    KSDS3D_IIR_COEFF_FORMAT     CoeffFormat;
} KSDS3D_IIR_FILTER_FORMAT_MSG, *PKSDS3D_IIR_FILTER_FORMAT_MSG;
...
#define KSDSOUND_3D_MODE_DISABLE         0x00000000
#define KSDSOUND_3D_MODE_HEADRELATIVE    0x00000001
#define KSDSOUND_3D_MODE_NORMAL          0x00000002
...
#define KSAUDIO_CPU_RESOURCES_HOST_CPU      0xFFFFFFFF
...
// Speaker Positions:
#define KSAUDIO_SPEAKER_LEFT                0x1
#define KSAUDIO_SPEAKER_RIGHT               0x2
#define KSAUDIO_SPEAKER_CENTER              0x4
#define KSAUDIO_SPEAKER_SURROUND_LEFT       0x8
#define KSAUDIO_SPEAKER_SURROUND_RIGHT      0x10
#define KSAUDIO_SPEAKER_SUBWOOFER           0x20
#define KSAUDIO_SPEAKER_LEFT_OF_CENTER      0x40
#define KSAUDIO_SPEAKER_RIGHT_OF_CENTER     0x80
#define KSAUDIO_SPEAKER_SURROUND_MONO       0x100
#define KSAUDIO_SPEAKER_SIDE_LEFT           0x200
#define KSAUDIO_SPEAKER_SIDE_RIGHT          0x400
#define KSAUDIO_SPEAKER_TOP                 0x800
#define KSAUDIO_SPEAKER_TOP_FRONT_LEFT      0x1000
#define KSAUDIO_SPEAKER_TOP_FRONT_CENTER    0x2000
#define KSAUDIO_SPEAKER_TOP_FRONT_RIGHT     0x4000
#define KSAUDIO_SPEAKER_TOP_REAR_LEFT       0x8000
#define KSAUDIO_SPEAKER_TOP_REAR_CENTER     0x10000
#define KSAUDIO_SPEAKER_TOP_REAR_RIGHT      0x20000


// DirectSound Speaker Config 
#define KSAUDIO_SPEAKER_MONO                KSAUDIO_SPEAKER_LEFT
#define KSAUDIO_SPEAKER_STEREO              (KSAUDIO_SPEAKER_LEFT | KSAUDIO_SPEAKER_RIGHT)
#define KSAUDIO_SPEAKER_QUAD                (KSAUDIO_SPEAKER_LEFT | KSAUDIO_SPEAKER_RIGHT | KSAUDIO_SPEAKER_SURROUND_LEFT | KSAUDIO_SPEAKER_SURROUND_RIGHT)
#define KSAUDIO_SPEAKER_SURROUND            (KSAUDIO_SPEAKER_LEFT | KSAUDIO_SPEAKER_RIGHT | KSAUDIO_SPEAKER_CENTER | KSAUDIO_SPEAKER_SURROUND_LEFT | KSAUDIO_SPEAKER_SURROUND_RIGHT | KSAUDIO_SPEAKER_SUBWOOFER)

// DVD Speaker Positions
#define KSAUDIO_SPEAKER_GROUND_FRONT_LEFT   KSAUDIO_SPEAKER_LEFT
#define KSAUDIO_SPEAKER_GROUND_FRONT_CENTER KSAUDIO_SPEAKER_CENTER
#define KSAUDIO_SPEAKER_GROUND_FRONT_RIGHT  KSAUDIO_SPEAKER_RIGHT
#define KSAUDIO_SPEAKER_GROUND_REAR_LEFT    KSAUDIO_SPEAKER_SURROUND_LEFT
#define KSAUDIO_SPEAKER_GROUND_REAR_RIGHT   KSAUDIO_SPEAKER_SURROUND_RIGHT
#define KSAUDIO_SPEAKER_TOP_MIDDLE          KSAUDIO_SPEAKER_TOP
#define KSAUDIO_SPEAKER_SUPER_WOOFER        KSAUDIO_SPEAKER_SUBWOOFER
...
#define STATIC_KSPROPSETID_Dls\
    0xb50be682L, 0xab59, 0x11d0, 0xaf, 0x8e, 0x00, 0xa0, 0xc9, 0x09, 0xb9, 0xe7
DEFINE_GUIDSTRUCT("b50be682-ab59-11d0-af8e-00a0c909b9e7", KSPROPSETID_Dls);
#define KSPROPSETID_Dls DEFINE_GUIDNAMED(KSPROPSETID_Dls)

#define KSPROPERTY_DLS_CAPS                 0x00000001  // dls device caps

#define STATIC_KSMETHODSETID_Dls\
    0xb3e474a0L, 0xaf53, 0x11d0, 0xaf, 0x96, 0x00, 0xa0, 0xc9, 0x09, 0xb9, 0xe7
DEFINE_GUIDSTRUCT("b3e474a0-af53-11d0-af96-00a0c909b9e7", KSMETHODSETID_Dls);
#define KSMETHODSETID_Dls DEFINE_GUIDNAMED(KSMETHODSETID_Dls)

#define KSMETHOD_DLS_OPEN_COLLECTION        0x00000001  // open collection file
#define KSMETHOD_DLS_CLOSE_COLLECTION       0x00000002  // close a collection file
#define KSMETHOD_DLS_DOWNLOAD_COLLECTION    0x00000003  // download an entire collection
#define KSMETHOD_DLS_DOWNLOAD_INSTRUMENT    0x00000004  // download a single instrument
#define KSMETHOD_DLS_RELEASE_COLLECTION     0x00000005  // free collection from device memory
#define KSMETHOD_DLS_RELEASE_INSTRUMENT     0x00000006  // free instrument from device memory
#define KSMETHOD_DLS_COMPACT                0x00000007  // compact device memory, if possible

typedef struct {
    DWORD               dwFlags;                        // device caps
    DWORD               dwStatus;                       // device status
    DWORD               dwPhysicalMemory;               // total physical memory
    DWORD               dwAvailableMemory;              // total available memory
    DWORD               dwContigousMemory;              // largest contiguous block of memory
} KSDLS_CAPS, *PKSDLS_CAPS;

typedef struct {
    DWORD               dwFlags;                        // collection description flags
    HANDLE              hCol;                           // collection handle
    union {
        PSTR            szFile;                         // file name (ansi_string)
        PVOID           pvMapFile;                      // memory mapped file
    } Source;
} KSDLS_COLLECTION_DESC, *PKSDLS_COLLECTION_DESC;

typedef struct {
    DWORD               dwFlags;                        // instrument description flags
    HANDLE              hCol;                           // collection which contains this instrument
    union {
        HANDLE          hInst;                          // instrument handle
        struct {
            WORD        wBank;                          // bank number
            WORD        wProgram;                       // instrument number
            WORD        wNoteLow;                       // instrument lowest note value
            WORD        wNoteHigh;                      // instrument highest note value
        } Range;
    };
} KSDLS_INSTRUMENT_DESC, *PKSDLS_INSTRUMENT_DESC;
...
#define STATIC_KSPROPSETID_Iir3d\
    0xb66decb0L, 0xa083, 0x11d0, 0x85, 0x1e, 0x00, 0xc0, 0x4f, 0xd9, 0xba, 0xf3
DEFINE_GUIDSTRUCT("b66decb0-a083-11d0-851e-00c04fd9baf3", KSPROPSETID_Iir3d);
#define KSPROPSETID_Iir3d DEFINE_GUIDNAMED(KSPROPSETID_Iir3d)

typedef enum {
    KSPROPERTY_IIR3D_PARAMS = 0,
    KSPROPERTY_IIR3D_MAX_SIZE,
    KSPROPERTY_IIR3D_FILTER_FORMAT
} KSPROPERTY_IIR3D;
...
#define KS_MPEG2_DSS_UserData        0x00000020  //if set, the MPEG-2 decoder must process DSS style user data
#define KS_MPEG2_DVB_UserData        0x00000040  //if set, the MPEG-2 decoder must process DVB style user data
#define KS_MPEG2_27MhzTimebase       0x00000080  //if set, the PTS,DTS timestamps advance at 27MHz rather than 90KHz
