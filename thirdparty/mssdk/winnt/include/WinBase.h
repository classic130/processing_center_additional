...
#if ((defined(_M_ALPHA) && (_MSC_VER >= 1000)) || defined(_M_IA64)) && !defined(RC_INVOKED)
...
#if (_WIN32_WINNT >= 0x0500) && (defined(_M_ALPHA))

//
// The same intrinsics work for 64-bit VLM pointers on Alpha
//
#define InterlockedIncrementVlm _InterlockedIncrement
#define InterlockedDecrementVlm _InterlockedDecrement
#define InterlockedExchangeVlm _InterlockedExchange
#define InterlockedExchangeAddVlm _InterlockedExchangeAdd
...
GetWriteWatch(
    ...
    IN DWORD dwRegionSize,
    IN LPDWORD addresses,
    IN LPDWORD count,
    IN LPDWORD granularity
    );
...
#ifdef UNICODE
#define GetSystemInfoEx  GetSystemInfoExW
#else
#define GetSystemInfoEx  GetSystemInfoExA
#endif // !UNICODE
