...
WINGDIAPI int  WINAPI AddFontResourceExA( IN LPCSTR, IN DWORD, IN DESIGNVECTOR *);
WINGDIAPI int  WINAPI AddFontResourceExW( IN LPCWSTR, IN DWORD, IN DESIGNVECTOR *);
#ifdef UNICODE
#define AddFontResourceEx  AddFontResourceExW
#else
#define AddFontResourceEx  AddFontResourceExA
#endif // !UNICODE
WINGDIAPI BOOL WINAPI RemoveFontResourceExA( IN LPCSTR, IN DWORD, IN DESIGNVECTOR *);
WINGDIAPI BOOL WINAPI RemoveFontResourceExW( IN LPCWSTR, IN DWORD, IN DESIGNVECTOR *);
#ifdef UNICODE
#define RemoveFontResourceEx  RemoveFontResourceExW
#else
#define RemoveFontResourceEx  RemoveFontResourceExA
#endif // !UNICODE
WINGDIAPI HANDLE WINAPI AddFontMemResourceEx( IN PVOID, IN DWORD, IN DESIGNVECTOR *, IN DWORD*);
...
WINGDIAPI int WINAPI StartFormPage(IN HDC);
WINGDIAPI int WINAPI EndFormPage(IN HDC);
