...
typedef enum _RAS_AUTH_ATTRIBUTE_TYPE_
{
    ...
    raatARAPChallenge  =   4133,    // Value field is a Pointer
    raatARAPGuestLogon,             // Value field is a 32 bit integral value
...
typedef struct _PPP_EAP_INPUT
{
    ...
    CHAR *      pszPassword;    // Client's account password. Only valid when
...
RasEapInvokeInteractiveUI(
    ...
    OUT LPDWORD         lpdwSizeOfDataFromInteractiveUI
);
...
RasEapInvokeConfigUI(
    ...
    OUT DWORD *         lpdwSizeOfConnectionDataOut
);
