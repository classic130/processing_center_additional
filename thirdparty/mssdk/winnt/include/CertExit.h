...
#ifndef __CCertManageExitModule_FWD_DEFINED__
#define __CCertManageExitModule_FWD_DEFINED__

#ifdef __cplusplus
typedef class CCertManageExitModule CCertManageExitModule;
#else
typedef struct CCertManageExitModule CCertManageExitModule;
#endif /* __cplusplus */

#endif 	/* __CCertManageExitModule_FWD_DEFINED__ */
...
EXTERN_C const CLSID CLSID_CCertManageExitModule;

#ifdef __cplusplus

class DECLSPEC_UUID("4e285786-bd3e-11d1-9a4d-00c04fc297eb")
