...
DECLARE_OPAQUE32(HAGENTSESSION);                                // TAPI v3.0
typedef HAGENTSESSION FAR * LPHAGENTSESSION;                    // TAPI v3.0

DECLARE_OPAQUE32(HAGENT);                                       // TAPI v3.0
typedef HAGENT FAR * LPHAGENT;                                  // TAPI v3.0
...
#if (TAPI_CURRENT_VERSION >= 0x00030000)
#define LINE_APPNEWCALLHUB                      27L             // TAPI v3.0
#define LINE_CALLHUBCLOSE                       28L             // TAPI v3.0
#define LINE_AGENTSESSIONSTATUS                 29L             // TAPI v3.0
#define LINE_QUEUESTATUS                        30L             // TAPI v3.0
#define LINE_DEVSPECIFICEX                      31L             // TAPI v3.0
#define LINE_AGENTSTATUSEX                      32L             // TAPI v3.0
#define LINE_GROUPSTATUS                        33L             // TAPI v3.0
#define LINE_PROXYSTATUS                        34L             // TAPI v3.0
#endif
...
#if (TAPI_CURRENT_VERSION >= 0x00030000)
#define LINEAGENTSTATEEX_NOTREADY               0x00000001      // TAPI v2.0
#define LINEAGENTSTATEEX_READY                  0x00000002      // TAPI v2.0
#define LINEAGENTSTATEEX_BUSYACD                0x00000004      // TAPI v2.0
#define LINEAGENTSTATEEX_BUSYINCOMING           0x00000008      // TAPI v2.0
#define LINEAGENTSTATEEX_BUSYOUTGOING           0x00000010      // TAPI v2.0
#define LINEAGENTSTATEEX_UNKNOWN                0x00000020      // TAPI v2.0
#define LINEAGENTSTATEEX_RELEASED               0x00000040      // TAPI v2.0

#define LINEAGENTSTATUSEX_NEWAGENT              0x00000001      // TAPI v2.0
#define LINEAGENTSTATUSEX_STATE                 0x00000002      // TAPI v2.0
#define LINEAGENTSTATUSEX_UPDATEINFO            0x00000003      // TAPI v2.0
//#define LINEAGENTSTATUSEX_DESTROYED             0x00000004      // TAPI v3.0

#define LINEAGENTSESSIONSTATE_NOTREADY          0x00000001      // TAPI v3.0
#define LINEAGENTSESSIONSTATE_READY             0x00000002      // TAPI v3.0
#define LINEAGENTSESSIONSTATE_BUSYONCALL        0x00000004      // TAPI v3.0
#define LINEAGENTSESSIONSTATE_BUSYWRAPUP        0x00000008      // TAPI v3.0
#define LINEAGENTSESSIONSTATE_ENDED             0x00000010      // TAPI v3.0
#define LINEAGENTSESSIONSTATE_RELEASED          0x00000020      // TAPI v3.0

#define LINEAGENTSESSIONSTATUS_NEWSESSION       0x00000001      // TAPI v3.0
#define LINEAGENTSESSIONSTATUS_STATE            0x00000002      // TAPI v3.0
#define LINEAGENTSESSIONSTATUS_UPDATEINFO       0x00000004      // TAPI v3.0
//#define LINEAGENTSESSIONSTATUS_DESTROYED        0x00000008      // TAPI v3.0

#define LINEQUEUESTATUS_UPDATEINFO              0x00000001      // TAPI v3.0
#define LINEQUEUESTATUS_NEWQUEUE                0x00000002      // TAPI v3.0
#define LINEQUEUESTATUS_QUEUEREMOVED            0x00000004      // TAPI v3.0

#define LINEGROUPSTATUS_NEWGROUP                0x00000001      // TAPI v3.0
#define LINEGROUPSTATUS_GROUPREMOVED            0x00000002      // TAPI v3.0

#define LINEPROXYSTATUS_OPEN                    0x00000001      // TAPI v3.0
#define LINEPROXYSTATUS_CLOSE                   0x00000002      // TAPI v3.0
#define LINEPROXYSTATUS_ALLOPENFORACD           0x00000004      // TAPI v3.0
...
#define LINEDEVCAPFLAGS_PARTICIPANTINFO         0x00000400      // TAPI v3.0
#define LINEDEVCAPFLAGS_CALLHUB                 0x00000800      // TAPI v3.0
#define LINEDEVCAPFLAGS_CALLHUBTRACKING         0x00001000      // TAPI v3.0
#define LINEDEVCAPFLAGS_PRIVATEOBJECTS          0x00002000      // TAPI v3.0
#endif
...
#if (TAPI_CURRENT_VERSION >= 0x00030000)
#define LINEPROXYREQUEST_CREATEAGENT                0x00000009  // TAPI v3.0
#define LINEPROXYREQUEST_SETAGENTMEASUREMENTPERIOD  0x0000000A  // TAPI v3.0
#define LINEPROXYREQUEST_GETAGENTINFO               0x0000000B  // TAPI v3.0
#define LINEPROXYREQUEST_CREATEAGENTSESSION         0x0000000C  // TAPI v3.0
#define LINEPROXYREQUEST_GETAGENTSESSIONLIST        0x0000000D  // TAPI v3.0
#define LINEPROXYREQUEST_SETAGENTSESSIONSTATE       0x0000000E  // TAPI v3.0
#define LINEPROXYREQUEST_GETAGENTSESSIONINFO        0x0000000F  // TAPI v3.0
#define LINEPROXYREQUEST_GETQUEUELIST               0x00000010  // TAPI v3.0
#define LINEPROXYREQUEST_SETQUEUEMEASUREMENTPERIOD  0x00000011  // TAPI v3.0
#define LINEPROXYREQUEST_GETQUEUEINFO               0x00000012  // TAPI v3.0
#define LINEPROXYREQUEST_GETGROUPLIST               0x00000013  // TAPI v3.0
#define LINEPROXYREQUEST_SETAGENTSTATEEX            0x00000014  // TAPI v3.0
#endif
...
typedef struct lineagententry_tag
{
    ...
    DWORD       dwNameSize;                                     // TAPI v3.0
    DWORD       dwNameOffset;                                   // TAPI v3.0
    DWORD       dwIDSize;                                       // TAPI v3.0
    DWORD       dwIDOffset;                                     // TAPI v3.0
    DWORD       dwPINSize;                                      // TAPI v3.0
    DWORD       dwPINOffset;                                    // TAPI v3.0
...
typedef struct lineagentlist_tag
{
    ...
    DWORD       dwNumEntries;                                   // TAPI v3.0
    DWORD       dwListSize;                                     // TAPI v3.0
    DWORD       dwListOffset;                                   // TAPI v3.0
...
typedef struct lineagentinfo_tag
{
    ...
    CURRENCY    cyOverallCallRate;                              // TAPI v3.0
    DWORD       dwNumberOfACDCalls;                             // TAPI v3.0
    DWORD       dwNumberOfIncomingCalls;                        // TAPI v3.0
    DWORD       dwNumberOfOutgoingCalls;                        // TAPI v3.0
    DWORD       dwTotalACDTalkTime;                             // TAPI v3.0
    DWORD       dwTotalACDCallTime;                             // TAPI v3.0
    DWORD       dwTotalACDWrapUpTime;                           // TAPI v3.0
...
typedef struct lineagentsessioninfo_tag
{
    ...
    DATE        dateSessionStartTime;                           // TAPI v3.0
    DWORD       dwSessionDuration;                              // TAPI v3.0
    DWORD       dwNumberOfCalls;                                // TAPI v3.0
    DWORD       dwTotalTalkTime;                                // TAPI v3.0
    DWORD       dwAverageTalkTime;                              // TAPI v3.0
    DWORD       dwTotalCallTime;                                // TAPI v3.0
    DWORD       dwAverageCallTime;                              // TAPI v3.0
    DWORD       dwTotalWrapUpTime;                              // TAPI v3.0
    DWORD       dwAverageWrapUpTime;                            // TAPI v3.0
    CURRENCY    cyACDCallRate;                                  // TAPI v3.0
    DWORD       dwLongestTimeToAnswer;                          // TAPI v3.0
    DWORD       dwAverageTimeToAnswer;                          // TAPI v3.0
...
typedef struct linequeueinfo_tag
{
    ...
    DWORD       dwUsedSize;                                     // TAPI v3.0
    DWORD       dwMeasurementPeriod;                                                        // TAPI v3.0
    DWORD       dwTotalCallsQueued;                             // TAPI v3.0
    DWORD       dwCurrentCallsQueued;                           // TAPI v3.0
    DWORD       dwTotalCallsAbandoned;                          // TAPI v3.0
    DWORD       dwTotalCallsFlowedIn;                           // TAPI v3.0
    DWORD       dwTotalCallsFlowedOut;                          // TAPI v3.0
    DWORD       dwLongestEverWaitTime;                          // TAPI v3.0
    DWORD       dwCurrentLongestWaitTime;                       // TAPI v3.0
    DWORD       dwAverageWaitTime;                              // TAPI v3.0
    DWORD       dwFinalDisposition;                             // TAPI v3.0
...
#if (TAPI_CURRENT_VERSION >= 0x00030000)
    GUID        PermanentPhoneGuid;                             // TAPI v3.0
#endif
...
LONG
WINAPI
lineCreateAgentSessionW(                                        // TAPI v3.0
    HLINE               hLine,
    HAGENT              hAgent,
    LPWSTR              lpszAgentPIN,
...
LONG
WINAPI
lineCreateAgentSessionA(                                        // TAPI v3.0
    HLINE               hLine,
    HAGENT              hAgent,
    LPSTR               lpszAgentPIN,
    DWORD               dwWorkingAddressID,
...
LONG
WINAPI
lineGetAgentSessionInfo(                                        // TAPI v3.0
    HLINE                   hLine,
...
LONG
WINAPI
lineGetAgentSessionList(                                        // TAPI v3.0
    HLINE                   hLine,
    HAGENTSESSION           hAgentSession,
...
LONG
WINAPI
lineGetCallHubTracking(                                         // TAPI v3.0
    HLINE                       hLine,
...
LONG
WINAPI
lineGetCallIDs(                                                 // TAPI v3.0
    HCALL               hCall,
    LPDWORD             lpdwAddressID,
    LPDWORD             lpdwCallID,
    LPDWORD             lpdwRelatedID
    );
#endif
...
LONG
WINAPI
lineGetHubRelatedCalls(                                         // TAPI v3.0
    HCALLHUB            hCallHub,
    HCALL               hCall,
    LPLINECALLLIST      lpCallList
    );
...
LONG
WINAPI
lineSetAgentMeasurementPeriod(                                  // TAPI v3.0
    HLINE               hLine,
    HAGENT              hAgent,
...
LONG
WINAPI
lineSetAgentSessionState(                                       // TAPI v3.0
    HLINE               hLine,
    HAGENTSESSION       hAgentSession,
...
LONG
WINAPI
lineSetCallHubTracking(                                         // TAPI v3.0
    HLINE                       hLine,
    LPLINECALLHUBTRACKINGINFO   lpTrackingInfo
    );
#endif
...
LONG
WINAPI
lineSetQueueMeasurementPeriod(                                  // TAPI v3.0
    HLINE               hLine,
    DWORD               dwQueueID,
    DWORD               dwMeasurementPeriod
    );
