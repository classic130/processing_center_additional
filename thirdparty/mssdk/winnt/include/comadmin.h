...
EXTERN_C const IID IID_ICOMAdminCatalog;
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE InstallApplication( 
            ...
            /* [optional][in] */ BSTR bstrPassword) = 0;
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE InstallMultipleComponents( 
            /* [in] */ BSTR bstrApplIdOrName,
            /* [in] */ SAFEARRAY __RPC_FAR * __RPC_FAR *varFileNames) = 0;
...
#define ICOMAdminCatalog_GetCollectionByQuery(This,bstrCollName,bstrQuery,ppCatalogCollection)	\
    (This)->lpVtbl -> GetCollectionByQuery(This,bstrCollName,bstrQuery,ppCatalogCollection)
...
#define ICOMAdminCatalog_InstallApplication(This,bstrApplicationFile,bstrDestinationDirectory,lOptions,bstrUserId,bstrPassword)	\
    (This)->lpVtbl -> InstallApplication(This,bstrApplicationFile,bstrDestinationDirectory,lOptions,bstrUserId,bstrPassword)
...
#define ICOMAdminCatalog_InstallMultipleComponents(This,bstrApplIdOrName,varFileNames)	\
    (This)->lpVtbl -> InstallMultipleComponents(This,bstrApplIdOrName,varFileNames)
...
enum __MIDL___MIDL_itf_comadmin_0109_0001
...
typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0002
...
typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0003
...
typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0004
...
typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0005
    {	COMAdminActivationInproc	= 0,
	COMAdminActivationLocal	= COMAdminActivationInproc + 1,
	COMAdminActivationDisabled	= COMAdminActivationLocal + 1
    }	COMAdminActivationOptions;

typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0006
    {	COMAdminProcessTypeNormal	= 0,
	COMAdminProcessTypeService	= COMAdminProcessTypeNormal + 1,
	COMAdminProcessTypeCOMPlus	= COMAdminProcessTypeService + 1,
	COMAdminProcessTypeLegacySurrogate	= COMAdminProcessTypeCOMPlus + 1
    }	COMAdminProcessTypeOptions;

typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0007
    {	COMAdminRunAsSpecifiedUser	= 0,
	COMAdminRunAsInteractiveUser	= COMAdminRunAsSpecifiedUser + 1,
	COMAdminRunAsLaunchingUser	= COMAdminRunAsInteractiveUser + 1
    }	COMAdminRunAsOptions;

typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0008
...
typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0009
    {	COMAdminImpersonationDefault	= 0,
	COMAdminImpersonationAnonymous	= COMAdminImpersonationDefault + 1,
...
typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0010
...
typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0011
...
typedef /* [public][helpstring] */ 
enum __MIDL___MIDL_itf_comadmin_0109_0012
	...
	COMAdminErrDetailedErrorsAvailable	= 0x80110401
    }	COMAdminErrorCodes;

#define E_COMAdmin_DETAILEDERRORS		 	COMAdminErrDetailedErrorsAvailable	
#define E_COMAdmin_OBJECTERRORS			 	COMAdminErrObjectErrors				
#define E_COMAdmin_OBJECTINVALID				COMAdminErrObjectInvalid				
#define E_COMAdmin_KEYMISSING				COMAdminErrKeyMissing				
#define E_COMAdmin_ALREADYINSTALLED			COMAdminErrAlreadyInstalled			
#define E_COMAdmin_DOWNLOADFAILED			COMAdminErrDownloadFailed			
#define E_COMAdmin_PDFWRITEFAIL				COMAdminErrPDFWriteFail				
#define E_COMAdmin_PDFREADFAIL				COMAdminErrPDFReadFail				
#define E_COMAdmin_PDFVERSION				COMAdminErrPDFVersion				
#define E_COMAdmin_COREQCOMPINSTALLED		COMAdminErrCoReqCompInstalled		
#define E_COMAdmin_BADPATH					COMAdminErrBadPath					
#define E_COMAdmin_PACKAGEEXISTS				COMAdminErrPackageExists				
#define E_COMAdmin_ROLEEXISTS				COMAdminErrRoleExists				
#define E_COMAdmin_CANTCOPYFILE				COMAdminErrCantCopyFile				
#define E_COMAdmin_NOTYPELIB					COMAdminErrNoTypeLib					
#define E_COMAdmin_NOUSER					COMAdminErrNoUser					
#define E_COMAdmin_INVALIDUSERIDS			COMAdminErrInvalidUserids			
#define E_COMAdmin_NOREGISTRYCLSID			COMAdminErrNoRegistryCLSID			
#define E_COMAdmin_BADREGISTRYPROGID			COMAdminErrBadRegistryProgID			
#define E_COMAdmin_AUTHENTICATIONLEVEL		COMAdminErrAuthenticationLevel		
#define E_COMAdmin_USERPASSWDNOTVALID		COMAdminErrUserPasswdNotValid		
#define E_COMAdmin_NOREGISTRYREAD			COMAdminErrNoRegistryRead			
#define E_COMAdmin_NOREGISTRYWRITE			COMAdminErrNoRegistryWrite			
#define E_COMAdmin_NOREGISTRYREPAIR			COMAdminErrNoRegistryRepair			
#define E_COMAdmin_CLSIDORIIDMISMATCH		COMAdminErrCLSIDOrIIDMismatch		
#define E_COMAdmin_REMOTEINTERFACE			COMAdminErrRemoteInterface			
#define E_COMAdmin_DLLREGISTERSERVER			COMAdminErrDllRegisterServer			
#define E_COMAdmin_NOSERVERSHARE				COMAdminErrNoServerShare				
#define E_COMAdmin_NOACCESSTOUNC				COMAdminErrNoAccessToUNC				
#define E_COMAdmin_DLLLOADFAILED				COMAdminErrDllLoadFailed				
#define E_COMAdmin_BADREGISTRYLIBID			COMAdminErrBadRegistryLibID			
#define E_COMAdmin_PACKDIRNOTFOUND			COMAdminErrPackDirNotFound			
#define E_COMAdmin_TREATAS					COMAdminErrTreatAs					
#define E_COMAdmin_BADFORWARD				COMAdminErrBadForward				
#define E_COMAdmin_BADIID					COMAdminErrBadIID					
#define E_COMAdmin_REGISTRARFAILED			COMAdminErrRegistrarFailed			
#define E_COMAdmin_COMPFILE_DOESNOTEXIST		COMAdminErrCompFileDoesNotExist		
#define E_COMAdmin_COMPFILE_LOADDLLFAIL		COMAdminErrCompFileLoadDLLFail		
#define E_COMAdmin_COMPFILE_GETCLASSOBJ		COMAdminErrCompFileGetClassObj		
#define E_COMAdmin_COMPFILE_CLASSNOTAVAIL	COMAdminErrCompFileClassNotAvail		
#define E_COMAdmin_COMPFILE_BADTLB			COMAdminErrCompFileBadTLB			
#define E_COMAdmin_COMPFILE_NOTINSTALLABLE	COMAdminErrCompFileNotInstallable	
#define E_COMAdmin_NOTCHANGEABLE				COMAdminErrNotChangeable				
#define E_COMAdmin_NOTDELETEABLE				COMAdminErrNotDeletable				
#define E_COMAdmin_SESSION					COMAdminErrSession					
#define E_COMAdmin_COMPFILE_NOREGISTRAR		COMAdminErrCompFileNoRegistrar		
#define E_COMAdmin_SERVICENOTINSTALLED		COMAdminErrServiceNotInstalled		
#define E_COMAdmin_CANNOTSHUTDOWNSYSTEMAPP	COMAdminErrCannotShutdownSystemApp		
