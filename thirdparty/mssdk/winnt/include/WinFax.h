...
typedef struct _FAX_JOB_PARAMA {
    ...
    DWORD               Reserved[3];                // reserved for ms use only
...
#define FEI_FAXSVC_STARTED          0x00000018
...
WINFAXAPI
BOOL
FaxRegisterServiceProviderA(
    IN HANDLE  FaxHandle,
    IN LPCSTR DeviceProvider,
    IN LPCSTR FriendlyName,
    IN LPCSTR ImageName,
    IN LPCSTR TspName
    );
WINFAXAPI
...
#else
#define FaxRegisterServiceProvider  FaxRegisterServiceProviderA
#endif // !UNICODE


typedef BOOL
(WINAPI *PFAXREGISTERSERVICEPROVIDERA)(
    IN HANDLE  FaxHandle,
    IN LPCSTR DeviceProvider,
    IN LPCSTR FriendlyName,
    IN LPCSTR ImageName,
...
#else
#define PFAXREGISTERSERVICEPROVIDER  PFAXREGISTERSERVICEPROVIDERA
#endif // !UNICODE

typedef BOOL
(CALLBACK *PFAX_ROUTING_INSTALLATION_CALLBACKA)(
    IN HANDLE FaxHandle,
    IN LPVOID Context,
    IN OUT LPSTR MethodName,
    IN OUT LPSTR FriendlyName,
    IN OUT LPSTR FunctionName,
    IN OUT LPSTR Guid
    );
typedef BOOL
...
#else
#define PFAX_ROUTING_INSTALLATION_CALLBACK  PFAX_ROUTING_INSTALLATION_CALLBACKA
#endif // !UNICODE


WINFAXAPI
BOOL
FaxRegisterRoutingExtensionA(
    IN HANDLE  FaxHandle,
    IN LPCSTR ExtensionName,
    IN LPCSTR FriendlyName,
    IN LPCSTR ImageName,
    IN PFAX_ROUTING_INSTALLATION_CALLBACKA CallBack,
    IN LPVOID Context
    );
WINFAXAPI
BOOL
...
#else
#define FaxRegisterRoutingExtension  FaxRegisterRoutingExtensionA
#endif // !UNICODE

typedef BOOL
(WINAPI *PFAXREGISTERROUTINGEXTENSIONA)(
    IN HANDLE  FaxHandle,
    IN LPCSTR ExtensionName,
    IN LPCSTR FriendlyName,
    IN LPCSTR ImageName,
...
#else
#define PFAXREGISTERROUTINGEXTENSION  PFAXREGISTERROUTINGEXTENSIONA
#endif // !UNICODE
