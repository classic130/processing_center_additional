...
class VSPTAv3 extends Plugin {
    ...
    */
	...
	public native int set_PTA_EnableCertForCapi(boolean boolEnableForCapi);
	...
	public native int set_UIPrefs_EnableTopMostWindow(boolean ShowTopMost);

	public native int set_UIPrefs_SignTransDlgWidth(int Width);
	public native int get_UIPrefs_SignTransDlgWidth();

	public native int set_UIPrefs_SignTransDlgHeight(int Height);
	public native int get_UIPrefs_SignTransDlgHeight();
	...
	/******************** Primary Digital Notarization Interface ********************/	
	public native int NZ_Initialize();
	public native int NZ_Close();

	public native int set_NZ_NotarizationServer(String ServerName);
	public native int set_NZ_HashAlg(String HashAlg);
	public native int set_NZ_DisplayDigitalID(int DisplayID);
	public native int set_NZ_CrlLocation(String CrlLocation);
	public native int set_NZ_ValidationPreference(int ValPref);
	public native int set_NZ_NotarizationDescription(String Description);

	public native String NZ_NotarizeDocument(String DocumentName, int UIMask, int ResponseType);
	public native String NZ_NotarizeHash(String Hash, int UIMask);
	public native int NZ_VerifyNotarizationRecord(String Record, String Document, int RecordType, int UIMask);
	public native int NZ_AddCertificate(String Certificate);

	/******************** User Preferences Interface of Digital Notarization ********************/
	public native int set_NZ_UIPrefs_LogoUrl(String LogoUrl);
	public native int set_NZ_UIPrefs_SelFileTitle(String SelFileTitle);
	public native int set_NZ_UIPrefs_SelFileDescription(String SelFileDesc);
	public native int set_NZ_UIPrefs_SelFileHelpUrl(String SelFileHelpUrl);
	public native int set_NZ_UIPrefs_ProgressTitle(String ProgressTitle);
	public native int set_NZ_UIPrefs_ProgressDescription(String ProgressDesc);
	public native int set_NZ_UIPrefs_ProgressHelpUrl(String ProgressHelpUrl);
	public native int set_NZ_UIPrefs_ReceiptTitle(String ReceiptTitle);
	public native int set_NZ_UIPrefs_ReceiptDescription(String ReceiptDesc);
	public native int set_NZ_UIPrefs_ReceiptHelpUrl(String ReceiptHelpUrl);
	public native int set_NZ_UIPrefs_WizardTitle(String WizardTitle);

	/******************** Application Preferences Interface of Digital Notarization ********************/
	public native int set_NZ_ApplicationPreference(String ApplicationName, String PreferenceName, int PreferenceType, String PreferenceValue);
	public native String get_NZ_ApplicationPreference(String ApplicationName, String PreferenceName);
}
