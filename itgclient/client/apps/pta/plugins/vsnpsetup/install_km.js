...
var listLongFilePaths = ["components/vscspsign", "components/vsnpsetupkm.exe", "components/ptav3.dll", "components/VSImport.dll"];
...
if(verifyDiskSpace(communicatorFolder, srDest))
{
  ...
  execute("components/vsnpsetupkm.exe", "NS6");
