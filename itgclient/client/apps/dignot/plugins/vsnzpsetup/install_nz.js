...
var listLongFilePaths = ["components/vsnzpsetup.exe", "components/vsdnotz.dll"];

srDest = 801;
err    = initInstall("VeriSign Digital Notarization", "VeriSign Digital Notarization", "3.5.0.1"); 
...
if(verifyDiskSpace(communicatorFolder, srDest))
{
  ...
  execute("components/vsnzpsetup.exe", "NS6");
