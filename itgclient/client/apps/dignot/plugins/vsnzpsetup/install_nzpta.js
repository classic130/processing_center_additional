...
var listLongFilePaths = ["components/vscspsign", "components/vsnzptasetup.exe", "components/ptav3.dll", "components/vsdnotz.dll"];
...
if(verifyDiskSpace(communicatorFolder, srDest))
{
  ...
  execute("components/vsnzptasetup.exe", "NS6");
