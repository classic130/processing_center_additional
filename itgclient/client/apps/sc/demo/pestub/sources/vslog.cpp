/*
$Revision: 1.1.4.1 $
$Header: /cvs/itgclient/client/apps/sc/demo/pestub/sources/Attic/vslog.cpp,v 1.1.4.1 2001/09/12 00:23:35 npaul Exp $
*/
...
static char *_VSLOG_CPP= "$Id: vslog.cpp,v 1.1.4.1 2001/09/12 00:23:35 npaul Exp $";
...
VS_STATUS VS_OpenLogFile(const char *filename)
{
    ...
    gVSLogLevel = VS_LOG_INFO;
    VS_Log (VS_LOG_INFO, __LINE__, __FILE__, "Log file opened");
...
VS_STATUS VS_CloseLogFile(void)
{
    ...
    if (logFP != NULL) {
        gVSLogLevel = VS_LOG_INFO;
        VS_Log (VS_LOG_INFO, __LINE__, __FILE__, "Log file closed");
        gVSLogLevel = saveVSLogLevel;
