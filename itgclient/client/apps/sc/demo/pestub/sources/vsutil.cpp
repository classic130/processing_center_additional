/*
 * $Revision: 1.1.4.1 $
 * $Header: /cvs/itgclient/client/apps/sc/demo/pestub/sources/Attic/vsutil.cpp,v 1.1.4.1 2001/09/12 00:23:36 npaul Exp $
 */
...
/*******************************************************************/
{
	...
	fprintf(debugFile, "%d: ", GetCurrentThreadId());
#else
	fprintf(debugFile, "%d: ", getpid());
#endif
	vfprintf(debugFile, format, vlist);
#ifdef NT_SERVICE
...
/*******************************************************************/
{
	...
	if ((list == NULL) || (debugFile == NULL))
		return;
	Log(debugFile, "%s at %s", msg, ctime(&now));
