...
class VS_TSS_Key {
   ...
   public:
	   ...
	   HRESULT GetKeyUsage(DWORD* o_pdwKeyUsage);
       HRESULT GetKeyLength(DWORD* o_pdwKeyLength);

	   HRESULT GetModulusLength(DWORD* o_pdwModulusLength);
	   HRESULT GetModulus(DWORD* o_pdwModulusLength, 
		...
		*/
	   HRESULT GetKey(TSS_HKEY* o_phKey);
};
