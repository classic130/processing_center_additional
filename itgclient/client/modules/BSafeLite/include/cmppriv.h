...
#if !defined(__CMPPRIV_H_)
#define __CMPPRIV_H_ 1
 ...
 */
int CMP_realloc (
  int,                                     /* Number of CMPWords needed */
  CMPInt *             /* The CMPInt for which space is to be realloc'd */
);
int CMP_reallocNoCopy (
  int,                                     /* Number of CMPWords needed */
  CMPInt *             /* The CMPInt for which space is to be realloc'd */
);
void CMP_free (
  CMPInt *          /* The CMPInt whose allocated space is to be free'd */
);
