 ...
 */
int A_RC2_CBCDecryptInit (thisCtx, key, params, mode)
...
/* Returns BE_OUTPUT_LEN, 0.
 */
int A_RC2_CBCDecryptUpdate
...
unsigned int partInLen;
{
  return (SecretCBCDecryptUpdate
          (thisCtx, (POINTER)&thisCtx->rc2Context, RC2Decrypt, partOut,
           partOutLen, maxPartOutLen, partIn, partInLen));
}

/* Returns AE_INPUT_LEN, AE_OUTPUT_LEN, 0.
 */
int A_RC2_CBCDecryptFinal (thisCtx, partOut, partOutLen, maxPartOutLen)
A_RC2_CBC_CTX *thisCtx;
unsigned char *partOut;
unsigned int *partOutLen;
unsigned int maxPartOutLen;
