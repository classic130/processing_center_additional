# Microsoft Developer Studio Project File - Name="ConfigChk" - Package Owner=<4>
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib version.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"Debug/VSCnfChk.dll" /pdbtype:sept
...
SOURCE="$(InputPath)"
PostBuild_Cmds=if not exist "..\..\lib\dynamic\debug" md "..\..\lib\dynamic\debug"	copy debug\vscnfchk.dll "..\..\lib\dynamic\debug"
...
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=if not exist "..\..\bin\debug" md "..\..\bin\debug"
# End Special Build Tool
...
# ADD CPP /nologo /MT /W3 /GX /O1 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_ATL_STATIC_REGISTRY" /D "MSG_BOX" /Yu"stdafx.h" /FD /c
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /machine:I386
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib version.lib /nologo /subsystem:windows /dll /machine:I386 /out:"ReleaseMinDependency/VSCnfChk.dll"
# Begin Custom Build - Performing registration
...
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=if not exist "..\..\lib\dynamic\release" md "..\..\lib\dynamic\release"	copy ReleaseMinDependency\vscnfchk.dll "..\..\lib\dynamic\release"
# End Special Build Tool
...
# Name "ConfigChk - Win32 Debug"
# Name "ConfigChk - Win32 Unicode Debug"
# Name "ConfigChk - Win32 Release MinSize"
# Name "ConfigChk - Win32 Release MinDependency"
# Name "ConfigChk - Win32 Unicode Release MinSize"
# Name "ConfigChk - Win32 Unicode Release MinDependency"
...
SOURCE=.\ConfigChk.def
# End Source File
# Begin Source File

SOURCE=.\ConfigChk.idl
# ADD MTL /tlb ".\ConfigChk.tlb" /h "ConfigChk.h" /iid "ConfigChk_i.c" /Oicf
# End Source File
# Begin Source File
