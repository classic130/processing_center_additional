...
if (errorFlag = "fail") then
	 msgBody=" Exchange Build failed please read the attachment log file for details"
else
 msgBody="There is a new baseline for exchange from " & cvsTag & ". The build is sucessfully completed. The statictag is " & staticTag & " and location is " & cdLocation & " Use this sitekit for further testing"
End If


	If (errorFlag = "fail") then
		MySendMail "itg-client-eng@verisign.com", msgBody, "build failed"
		MySendMail "aalsup@verisign.com",msgBody,"build failed."
		MySendMail "eleung@verisign.com",msgBody,"build failed."
	        MySendMail "mnguyen@verisign.com",msgBody,"build failed."
	else
	      'Call our function with recipient, message and subject
	      MySendMail "itg-client-eng@verisign.com",msgBody,"build finished."
	      MySendMail "aalsup@verisign.com",msgBody,"build finished."
	      MySendMail "eleung@verisign.com",msgBody,"build finished."
	      MySendMail "mnguyen@verisign.com",msgBody,"build finished."
	End If 
