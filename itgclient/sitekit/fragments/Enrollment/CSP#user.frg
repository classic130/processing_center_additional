...
// if userEnrollNS.htm has to use CAPI and MS cert store
...
<!-- VSSKBEGINPOLICYVAL#user#5#1.2.0.4 -->
  var ProviderName;
  var selectedProv;
  ...
  {
    selectedProv = document.proform.cryptoProviders[document.proform.cryptoProviders.selectedIndex].value ;
  }
