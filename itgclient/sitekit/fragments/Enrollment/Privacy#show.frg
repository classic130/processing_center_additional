...
<!-- VSSKENDPOLICYVAL#show#1 -->


<!-- VSSKBEGINPOLICYVAL#show#2 -->
		     if(document.proform.additional_field3.value.indexOf("Agreement accepted") == -1) { 
