<!-- VSSKBEGINPOLICYVAL#512#1 -->
  ...
  End If
<!-- VSSKENDPOLICYVAL#512#1 -->

<!-- VSSKBEGINPOLICYVAL#512#2 -->
...
<!-- VSSKENDPOLICYVAL#512#2 -->


<!-- VSSKBEGINPOLICYVAL#512#3 -->
Dim bKeyGenSuccess
Dim bKeyGen
Dim keyflags
Dim keygenflags
...
<!-- VSSKENDPOLICYVAL#512#3 -->

<!-- VSSKBEGINPOLICYVAL#512#4 -->
    Dim KeyAttributes
    ' for 512 bit keys
    KeyAttributes = KeyFlags OR &h02000000
    On Error Resume Next
    CreatePKCS10 = IVSPTA.CreateCertReq (SubjectDN, KeyAttributes, HashAlg, Attributes)
<!-- VSSKENDPOLICYVAL#512#4 -->

<!-- VSSKBEGINPOLICYVAL#512#5#1.2.0.4 -->
   var KeyAttributes;
   KeyAttributes = 0x02000000 | KeyFlags;
   if(browserNum < 5)
   {
...
<!-- VSSKENDPOLICYVAL#512#5 -->

<!-- VSSKBEGINPOLICYVAL#512#6 -->
CONST keySize  512
<!-- VSSKENDPOLICYVAL#512#6 -->
