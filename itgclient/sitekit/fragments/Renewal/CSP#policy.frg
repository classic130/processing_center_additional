...
// for auto submit of userRenewalMS.htm and userRenewalNS.htm in WAC case...
<!-- VSSKBEGINPOLICYVAL#policy#4 -->
   <!-- VSSKBEGIN Renewal/KeyProtect#3 -->
   <!-- VSSKEND Renewal/KeyProtect#3 -->
<!-- VSSKENDPOLICYVAL#policy#4 -->


// display the CSP selection box...
<!-- VSSKBEGINPOLICYVAL#policy#5 -->
<!-- VSSKENDPOLICYVAL#policy#5 -->

// to verify the CSP 
<!-- VSSKBEGINPOLICYVAL#policy#6#1.2.0.4 -->
  var selectedProv;
...
<!-- VSSKBEGINPOLICYVAL#policy#7 -->
  <!-- VSSKBEGIN Renewal/KeyProtect#5 -->
  <!-- VSSKEND Renewal/KeyProtect#5 -->
<!-- VSSKENDPOLICYVAL#policy#7 -->

<!-- VSSKBEGINPOLICYVAL#policy#8 -->
   <!-- VSSKBEGIN Renewal/KeyProtect#6 -->
   <!-- VSSKEND Renewal/KeyProtect#6 -->
<!-- VSSKENDPOLICYVAL#policy#8 -->
