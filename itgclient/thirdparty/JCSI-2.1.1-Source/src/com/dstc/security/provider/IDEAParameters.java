...
/**
 * <p>Implements java.security.AlgorithmParameters for the IDEA
 * encryption algorithm
 *
 * <p>Implements the ASN.1 structure IDEA-CBCPar
 * <pre>
 ...
 *
 */
public final class IDEAParameters extends AlgorithmParametersSpi 
{
  ...
  /**
   * Constructs a IDEA-CBCPar from an IvParameterSpec
   */
  private void encode()
  {
    this.asn1 = new Sequence();
    asn1.add(new com.dstc.security.asn1.OctetString(ivSpec.getIV()));
  }
  ...
  private void decode(Asn1 asn1) throws IOException
  {
    ...
    while (it.hasNext())
    {
        ...
        this.ivSpec = new IvParameterSpec(os.getBytes());
    }
  }
  ...
  {
    StringBuffer sb = new StringBuffer("IDEA Parameters");
    return sb.toString(); 
  }
