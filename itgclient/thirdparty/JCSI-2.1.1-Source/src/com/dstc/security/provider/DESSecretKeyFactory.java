...
/**
 * <p>Implements a Factory class for secret keys to use with the DES cipher.
 *
...
public final class DESSecretKeyFactory extends SymmetricKeyFactory
{
    ...
    throws InvalidKeySpecException
  {
    if (keySpec instanceof DESKeySpec)
      return new SymmetricKey(alg, ((DESKeySpec)keySpec).getKey()); 
    ...
    throws InvalidKeySpecException
  {
    try
    {
      if ((keySpec.equals(DESKeySpec.class)))
