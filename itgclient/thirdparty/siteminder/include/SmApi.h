...
//
*/
typedef Sm_AuthApi_Status_t (SM_EXTERN *Sm_AuthApi_Init_t)
(
const char* lpszParam,                  /* parameter (null-terminated) */
const char* lpszSharedSecret            /* shared secret (null-terminated) */
);
...
//
*/
typedef Sm_AuthApi_Status_t (SM_EXTERN *Sm_AuthApi_Release_t)
(
    const char* lpszParam,                  /* parameter (null-terminated) */
    const char* lpszSharedSecret            /* shared secret (null-terminated) */
);
...
//
*/
typedef Sm_AuthApi_Status_t (SM_EXTERN *Sm_AuthApi_Authenticate_t)
(
...
const Sm_Api_Reason_t                   nChallengeReason,       /* the reason for the original challenge; 0 otherwise */
...
,Sm_PolicyResolution_Max          = 11     /* last */
};

static char *lpszPolicyResolutionNames[] =
{
  "Unknown"                    /* Sm_PolicyResolution_Unknown */
, "User"                       /* Sm_PolicyResolution_User */
, "User Group"                 /* Sm_PolicyResolution_UserGroup */
, "User Attribute"             /* Sm_PolicyResolution_UserProp */
, "User Role"                  /* Sm_PolicyResolution_UserProp */
, "Organization"               /* Sm_PolicyResolution_Org */
, "Query"                      /* Sm_PolicyResolution_Query */
, "All"                        /* Sm_PolicyResolution_All */
, "Group Attribute"            /* Sm_PolicyResolution_GroupProp */
, "Org Attribute"              /* Sm_PolicyResolution_OrgProp */
, "DN Attribute"               /* Sm_PolicyResolution_DnProp */
};
...
//
*/
typedef Sm_DmsWorkflowApi_Status_t (SM_EXTERN *Sm_DmsWorkflowApi_Init_t)
(
);
...
//
*/
typedef Sm_DmsWorkflowApi_Status_t (SM_EXTERN *Sm_DmsWorkflowApi_Release_t)
(
);
...
//
*/
typedef Sm_DmsWorkflowApi_Status_t (SM_EXTERN *Sm_DmsWorkflowApi_Preprocess_t)
(
const Sm_Api_Context_t*                 lpApiContext,       /* the structure that provides API context */
...
//
*/
typedef Sm_DmsWorkflowApi_Status_t (SM_EXTERN *Sm_DmsWorkflowApi_Postprocess_t)
(
const Sm_Api_Context_t*                 lpApiContext,       /* the structure that provides API context */
const Sm_Api_DmsContext_t*              lpDmsContext,       /* the structure that provides DMS directory context */
const char *                            lpszWorkflowOid,    /* the workflow unique object ID */
