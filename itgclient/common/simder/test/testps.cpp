...
{
  _DWORD i, length ;
  char		string[] = {"This is a really long string that really scares the heck out of me. This is a really long string that really scares the heck out of me."} ;
  ...
  strcpy(szDecodedString, (const char *)cps1.pbData) ;
  printf("Decoded String from cps1 is : \n%s\n", szDecodedString) ;
  printf("Decoded String Length from cps1 is : %d\n\n", cps1.cbData) ;
